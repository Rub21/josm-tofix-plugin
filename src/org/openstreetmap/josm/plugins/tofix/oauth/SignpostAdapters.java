...
import org.openstreetmap.josm.plugins.tofix.oauth.signpost.AbstractOAuthConsumer;
import org.openstreetmap.josm.plugins.tofix.oauth.signpost.AbstractOAuthProvider;
...
public final class SignpostAdapters {
    ...
    public static class OAuthProvider extends AbstractOAuthProvider {
        ...
        @Override
        protected HttpResponse sendRequest(org.openstreetmap.josm.plugins.tofix.oauth.signpost.http.HttpRequest request) throws Exception {
            return new HttpResponse(((HttpRequest) request).request.connect());
        }

        @Override
        protected void closeConnection(org.openstreetmap.josm.plugins.tofix.oauth.signpost.http.HttpRequest request, org.openstreetmap.josm.plugins.tofix.oauth.signpost.http.HttpResponse response) throws Exception {
            if (response != null) {
    ...
    static final class HttpRequest implements org.openstreetmap.josm.plugins.tofix.oauth.signpost.http.HttpRequest {
    ...
    static final class HttpResponse implements org.openstreetmap.josm.plugins.tofix.oauth.signpost.http.HttpResponse {
